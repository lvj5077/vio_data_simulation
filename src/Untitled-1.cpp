...
MotionData IMU::MotionModel(double t)
{
    ...
    if(t<5){ 
        ...
        position.y() = ellipse_init * sin( K * t) + 5. -4.;
        position.z() = ellipse_init * sin( K * t) + 5. -4.;
    ...
    {
        // speed up
        position.x() = ellipse_x * cos( K * t) + 5 + ellipse_x*2.;
        ...
        eulerAngles.z() = K*t_temp*t_temp/10.;
